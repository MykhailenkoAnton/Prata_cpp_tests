...
int main()
{
    ...
    std::cout << "Number of cities with area code 415: "
            << codes.count(415) << std::endl; // количество городов с кодом региона 415
    std::cout << "Number of cities with area code 718: "
            << codes.count(718) << std::endl; // количество городов с кодом региона 718
    std::cout << "Number of cities with area code 510: "
            << codes.count(510) << std::endl; // количество городов с кодом региона 510
